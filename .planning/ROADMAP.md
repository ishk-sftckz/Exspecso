...
- [ ] 01-10-PLAN.md — Prove installed POSIX and Windows native promotion tracers (Task 1 verified; tracer feedback pending before Windows)
...
|-------|----------------|--------|-----------|
| 1. Initialize Canonical Projects | 9/18 | POSIX tracer verified; feedback and remaining native work pending | - |
